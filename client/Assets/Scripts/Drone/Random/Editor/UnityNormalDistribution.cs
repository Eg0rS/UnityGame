...
{
    public static class UnityNormalDistribution
    {
        private static double Normal_cdf(double u)
        {
            const double M_1_SQRT_PI = 0.564189583547756286948;
            double msqrt2 = 1.41421356237309504880;
            double z;

            double[] a = new double[] {
                    1.161110663653770e-002, 3.951404679838207e-001, 2.846603853776254e+001, 1.887426188426510e+002, 3.209377589138469e+003
            };

            double[] b = new double[] {
                    1.767766952966369e-001, 8.344316438579620e+000, 1.725514762600375e+002, 1.813893686502485e+003, 8.044716608901563e+003
            };

            double[] c = new double[] {
                    2.15311535474403846e-8, 5.64188496988670089e-1, 8.88314979438837594e00, 6.61191906371416295e01, 2.98635138197400131e02,
                    8.81952221241769090e02, 1.71204761263407058e03, 2.05107837782607147e03, 1.23033935479799725E03
            };

            double[] d = new double[] {
                    1.00000000000000000e00, 1.57449261107098347e01, 1.17693950891312499e02, 5.37181101862009858e02, 1.62138957456669019e03,
                    3.29079923573345963e03, 4.36261909014324716e03, 3.43936767414372164e03, 1.23033935480374942e03
            };

            double[] p = new double[] {
                    1.63153871373020978e-2, 3.05326634961232344e-1, 3.60344899949804439e-1, 1.25781726111229246e-1, 1.60837851487422766e-2,
                    6.58749161529837803e-4
            };

            double[] q = new double[] {
                    1.00000000000000000e00, 2.56852019228982242e00, 1.87295284992346047e00, 5.27905102951428412e-1, 6.05183413124413191e-2,
        ...
        private static double Normal_inv(double p)
        {
            const double M_SQRT2_PI = 2.50662827463100;
            double[] a = new double[] {
            ...
            t = t * M_SQRT2_PI * Math.Exp(u * u / 2); /* f(u)/df(u) */
